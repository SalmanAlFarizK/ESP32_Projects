...
void InitBlueTooth(void)
{
  ...
  if (!SerialBT.begin("ESP32_SFK")) 
  {
    Serial.println("An error occurred initializing Bluetooth");
  } 
  else 
  {
    Serial.println("Bluetooth started. Waiting for a connection...");
  }

  return;
}

void SendToBlueTooth(char* pucData)
{
  if (SerialBT.hasClient()) 
  {
    SerialBT.println(pucData);
    Serial.println("Data is sent to bluetooth!");
  } 
  else 
  {
